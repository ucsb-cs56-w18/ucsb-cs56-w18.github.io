...
<ul markdown="1">
  <li style="list-style-type:circle;" markdown="1"> print `The Box is checked!` if the box is checked </li>
  <li style="list-style-type:circle;" markdown="1"> print `The Box is not checked!` if the box is unchecked.</li>
</ul>
